    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#1B2A45] py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-11 grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
          <div>
            <h2 className="font-[family-name:var(--font-fraunces)] font-[500] text-[#FAF8F3] text-[34px] md:text-[40px] leading-[1.04] tracking-[-0.01em] mb-6">
          ...
          <div className="bg-[#0F1B2E] rounded-md p-8 flex flex-col gap-6 border border-[rgba(250,248,243,0.1)]">
            {[
      ...
      <section className="relative overflow-hidden bg-[#1B2A45] py-20 md:py-28">
        <div className="relative max-w-6xl mx-auto px-6 md:px-11 text-center">
          <h2 className="font-[family-name:var(--font-fraunces)] font-[400] text-[#FAF8F3] text-[40px] md:text-[52px] lg:text-[64px] leading-[1.04] tracking-[-0.015em] mb-8 max-w-3xl mx-auto">
