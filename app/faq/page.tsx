              ...
              <div key={section.title}>
                ...
                <div className="flex flex-col gap-6">
                  {section.faqs.map((faq) => (
                    ...
                    >
                      <h3 className="font-[family-name:var(--font-fraunces)] font-[500] text-[#4A2A43] text-[21px] leading-[1.3]">
                        {faq.q}
                      </h3>
                ...
                {i === 1 && (
                  <div className="mt-8 border-l-2 border-[#4A2A43] pl-6 py-1">
                    <p className="font-[family-name:var(--font-fraunces)] font-[500] text-[#4A2A43] text-[23px] mb-2">
                      Not sure what it&apos;ll cost you?
                    </p>
                    <p className="text-[21px] text-[#2B2329] leading-relaxed mb-3">
